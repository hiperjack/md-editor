...
const DICT: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    "dlg.closeAll.review": "確認する(Y)",
    "dlg.closeAll.discard": "破棄して終了(N)",
    ...
    "tb.bold": "太字 (Ctrl+B)",
    "tb.italic": "斜体 (Ctrl+I)",
    "tb.underline": "下線 (Ctrl+U)",
    "tb.textColor": "文字色（クリック=直近の色、ホバー=パレット）",
    "tb.highlight": "ハイライト（クリック=直近の色、ホバー=パレット）",
    "tb.sup": "上付き",
    "tb.sub": "下付き",
    "tb.clearFormat": "書式をクリア",
    "tb.tasklist": "タスクリスト",
    "tb.callout": "コールアウト",
    "tb.export": "出力",
    "tb.more": "その他のボタン",
    ...
    "color.standard": "標準の色",
    "color.clear": "色を解除",
    "color.highlight": "ハイライトの色",
    "color.markDefault": "標準マーカー（黄）",
    ...
    "tb.table": "表を挿入",
    "table.pick.size": "{rows} × {cols} の表",
    "table.pick.hint": "行数 × 列数を選択",
    "tb.link": "リンク (Ctrl+K)",
    "tb.image": "画像",
    "tb.hr": "区切り線",
    "tb.settings": "設定",
    ...
    "chat.new": "新しい会話",
    "chat.history": "履歴",
    "chat.historyEmpty": "履歴はありません",
    "chat.historyClear": "履歴をすべて削除",
    "chat.historyDeleteOne": "この会話を削除",
    "chat.placeholder": "文書について質問・依頼を入力…",
    "chat.send": "送信",
    "chat.stop": "停止",
    "chat.apply": "適用",
    "chat.newTab": "新規タブへ",
    "chat.discard": "破棄",
    "chat.applied": "適用しました",
    "chat.appliedAlready": "適用済みです（文書は提案と同じ内容）",
    "chat.openedInNewTab": "新規タブに出力しました",
    "chat.discarded": "破棄しました",
    "chat.applyFailed": "適用できませんでした（タブが閉じられた可能性があります）",
    "chat.diffRefreshed":
      "文書が変更されたため差分を更新しました。内容を確認してもう一度「適用」を押してください。",
    "chat.proposalTitle": "編集提案",
    "chat.proposalWholeDoc": "文書全体が置き換わります",
    "chat.noTab": "編集タブを開くとチャットを利用できます",
    "chat.errNotFound":
      "Claude Code CLI が見つかりません。https://claude.com/claude-code からインストールしてください。",
    "chat.errLogin":
      "Claude Code にログインしていない可能性があります。ターミナルで claude を実行してログインしてください。",
    "chat.errGeneric": "エラーが発生しました",
    "chat.errSessionLost": "前の会話を再開できませんでした。新しい会話として送信します。",
    "chat.menu": "Claudeチャット",
    "chat.searching": "Web検索中…",
    "cm.quoteToChat": "選択をチャットで引用",
    "chat.presentation": "プレゼン変換",
    // Claude使用量（ヘルプメニュー・モーダル・チャットヘッダー）
    "usage.title": "Claude使用量",
    "usage.fiveHour": "5時間",
    "usage.sevenDay": "7日間",
    "usage.resets": "リセット: {time}",
    "usage.loading": "取得中…",
    "usage.retry": "再試行",
    "usage.close": "閉じる",
    "usage.errAuth":
      "Claude Code の認証情報を取得できませんでした。チャットを一度使うと更新されます。",
    ...
    "find.replaceTitle": "置換 (Alt+R)",
    "find.replaceAllTitle": "すべて置換 (Alt+A)",
    ...
    "pres.next": "次のスライド",
    "pres.laser": "レーザー",
    "pres.laserMenu": "レーザーポインタ",
    "pres.present": "発表（先頭から）",
    "pres.presentHere": "このページから発表",
    "pres.fullscreen": "発表",
    "pres.empty": "スライドがありません",
    "pres.endTitle": "スライドショーの最後です",
    "pres.endHint": "→ またはクリックで終了（先頭へ）",
    "menu.presentToggle": "デッキ／一覧を切替（プレゼン）",
    ...
    "menu.presentation": "プレゼン表示",
    "menu.presentationPdf": "プレゼンをPDF出力...",
    "menu.presentationHtml": "プレゼンをHTML出力...",
    "menu.print": "印刷...",
    "menu.close": "タブを閉じる",
    "menu.removeRecent": "一覧から削除",
    "menu.quit": "終了",
    "menu.undo": "元に戻す",
    "menu.redo": "やり直し",
    "menu.cut": "切り取り",
    ...
    "menu.settings": "設定...",
    "menu.claudeUsage": "Claude使用量...",
    "menu.about": "mdeditについて",
    // マクロ
    "menu.macro": "マクロ",
    "menu.macroRecord": "記録/停止",
    "menu.macroPlay": "再生",
    "menu.macroPlayRepeat": "繰り返し再生...",
    "menu.macroSave": "保存...",
    "menu.macroLoad": "読込...",
    "macro.recording": "● 記録中",
    "macro.repeatPrompt": "繰り返し回数を入力してください (1〜9999)",
    "macro.invalidCount": "回数が不正です。",
    "macro.invalidFile": "マクロファイルではありません。",
    "macro.saveTitle": "マクロを保存",
    "macro.loadTitle": "マクロを読込",
    "macro.aborted": "マクロ再生を中断しました（{done}/{total}回実行）",
    "macro.saveFailed": "マクロの保存に失敗しました。",
    "macro.loadFailed": "マクロの読込に失敗しました。",
    "print.preparing": "印刷を準備中…",
    "presPdf.preparing": "プレゼンPDFを準備中…",
    "presPdf.failed": "プレゼンPDFの準備に失敗しました。",
    "presHtml.dialogTitle": "プレゼンをHTML出力",
    ...
    "settings.gantt.section": "ガント表示スタイル",
    "settings.gantt.document": "文書（プレビュー・HTML出力・印刷）",
    "settings.gantt.slide": "スライド（プレゼン・スライド出力）",
    "settings.gantt.mermaid": "Mermaid（標準）",
    "settings.gantt.ppt": "スケジュールチャート（PowerPoint風）",
    "docTheme.font.family": "本文フォント",
    "docTheme.font.yuGothic": "游ゴシック",
    "docTheme.font.meiryoUi": "Meiryo UI",
  ...
  en: {
    ...
    "dlg.save.save": "Save (Y)",
    "dlg.save.discard": "Discard (N)",
    ...
    "dlg.closeAll.review": "Review (Y)",
    "dlg.closeAll.discard": "Discard and quit (N)",
    ...
    "tb.underline": "Underline (Ctrl+U)",
    "tb.textColor": "Text color (click = last used, hover = palette)",
    "tb.highlight": "Highlight (click = last used, hover = palette)",
    "tb.sup": "Superscript",
    "tb.sub": "Subscript",
    "tb.clearFormat": "Clear formatting",
    "tb.tasklist": "Task list",
    "tb.callout": "Callout",
    "tb.export": "Export",
    "tb.more": "More tools",
    ...
    "color.markDefault": "Default marker (yellow)",
    ...
    "table.pick.size": "{rows} × {cols} table",
    "table.pick.hint": "Choose rows × columns",
    "tb.link": "Link (Ctrl+K)",
    "tb.image": "Image",
    ...
    "chat.historyEmpty": "No history",
    "chat.historyClear": "Clear all history",
    "chat.historyDeleteOne": "Delete this conversation",
    "chat.placeholder": "Ask or request changes to the document…",
    "chat.send": "Send",
    "chat.stop": "Stop",
    "chat.apply": "Apply",
    "chat.newTab": "New tab",
    ...
    "chat.appliedAlready": "Already applied (document matches the proposal)",
    ...
    "chat.diffRefreshed":
      "The document changed, so the diff was refreshed. Review it and press Apply again.",
    "chat.proposalTitle": "Proposed edit",
    "chat.proposalWholeDoc": "The whole document will be replaced",
    "chat.noTab": "Open an editor tab to use the chat",
    "chat.errNotFound":
      "Claude Code CLI not found. Install it from https://claude.com/claude-code.",
    "chat.errLogin":
      "You may not be logged in to Claude Code. Run claude in a terminal to log in.",
    "chat.errGeneric": "An error occurred",
    ...
    "chat.presentation": "To slides",
    // Claude usage (help menu, modal, chat header)
    ...
    "usage.close": "Close",
    "usage.errAuth":
      "Could not read Claude Code credentials. Using the chat once will refresh them.",
    ...
    "find.replaceTitle": "Replace (Alt+R)",
    "find.replaceAllTitle": "Replace All (Alt+A)",
    ...
    "tabcm.presentation": "Open presentation view",
    ...
    "tb.file_presentation": "Presentation (Ctrl+Shift+P)",
    "tb.source_toggle": "Source view (raw Markdown, Ctrl+Shift+I)",
    "preview.tabPrefix": "Preview: ",
    "preview.slideTabPrefix": "Slides: ",
    "preview.cannotRefresh": "Cannot refresh (source file/tab not found)",
    // Presentation (slideshow)
    "pres.deckView": "Deck",
    "pres.gridView": "Grid",
    "pres.prev": "Previous slide",
    "pres.next": "Next slide",
    "pres.laser": "Laser",
    "pres.laserMenu": "Laser pointer",
    "pres.present": "Present (from start)",
    "pres.presentHere": "Present from this slide",
    "pres.fullscreen": "Present",
    "pres.empty": "No slides",
    "pres.endTitle": "End of slide show",
    "pres.endHint": "Press → or click to exit (back to start)",
    "menu.presentToggle": "Toggle deck/grid (presentation)",
    ...
    "menu.presentation": "Presentation view",
    "menu.presentationPdf": "Export Slides as PDF...",
    "menu.presentationHtml": "Export Slides as HTML...",
    "menu.print": "Print...",
    "menu.close": "Close tab",
    "menu.removeRecent": "Remove from list",
    "menu.quit": "Quit",
    "menu.undo": "Undo",
    "menu.redo": "Redo",
    "menu.cut": "Cut",
    ...
    "menu.sup": "Superscript",
    "menu.sub": "Subscript",
    "menu.clearFormat": "Clear Formatting",
    ...
    "menu.claudeUsage": "Claude Usage...",
    "menu.about": "About mdedit",
    // Macro
    "menu.macro": "Macro",
    "menu.macroRecord": "Record/Stop",
    "menu.macroPlay": "Play",
    "menu.macroPlayRepeat": "Play Repeatedly...",
    "menu.macroSave": "Save...",
    "menu.macroLoad": "Load...",
    "macro.recording": "● REC",
    "macro.repeatPrompt": "Enter repeat count (1-9999)",
    "macro.invalidCount": "Invalid count.",
    "macro.invalidFile": "Not a valid macro file.",
    "macro.saveTitle": "Save Macro",
    "macro.loadTitle": "Load Macro",
    "macro.aborted": "Macro playback stopped ({done}/{total} runs).",
    "macro.saveFailed": "Failed to save macro.",
    "macro.loadFailed": "Failed to load macro.",
    "print.preparing": "Preparing to print…",
    "presPdf.preparing": "Preparing slides PDF…",
    "presPdf.failed": "Failed to prepare slides PDF.",
    "presHtml.dialogTitle": "Export Slides as HTML",
    "print.failed": "Failed to prepare printing.",
    "cb.previewLabel": "Preview",
    "cb.previewLoading": "Rendering diagram…",
    "cb.previewEdit": "Edit",
    "cb.previewHide": "Hide",
    "cb.previewError": "Mermaid syntax error",
    "cb.unwrap": "Unwrap",
    ...
    "settings.gantt.section": "Gantt chart style",
    "settings.gantt.document": "Document (preview, HTML export, print)",
    "settings.gantt.slide": "Slides (presentation, slide export)",
    "settings.gantt.mermaid": "Mermaid (default)",
    "settings.gantt.ppt": "Schedule chart (PowerPoint-style)",
