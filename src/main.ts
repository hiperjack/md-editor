  ...
  const buildMenus = (): TopMenu[] => [
    ...
    },
    {
      ...
      items: () => [
        ...
        { type: "item", label: t("menu.highlight"), mnemonic: "G", run: fmtActions.fmt_highlight_menu },
        ...
        { type: "item", label: t("menu.sup"), mnemonic: "P", run: fmtActions.fmt_sup },
        { type: "item", label: t("menu.sub"), mnemonic: "W", run: fmtActions.fmt_sub },
        { type: "item", label: t("menu.clearFormat"), mnemonic: "R", run: fmtActions.fmt_clear },
        { type: "sep" },
        ...
        { type: "item", label: t("menu.callout"), mnemonic: "O", run: fmtActions.fmt_callout_menu },
        ...
        { type: "item", label: t("menu.tasklist"), mnemonic: "X", run: fmtActions.fmt_task },
