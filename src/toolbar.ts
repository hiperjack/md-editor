...
export const ICONS: Record<string, string> = {
  ...
  panel_right:
    "M3 3h18a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zM15 3v18",
  settings:
...
const BUTTONS: ButtonSpec[] = [
  ...
  // 右端: Claudeチャットパネル（右サイドバー）の表示トグル。パネルの真上に配置。
  { key: "view_chat", icon: ICONS.panel_right, titleKey: "tb.chat", align: "right" },
